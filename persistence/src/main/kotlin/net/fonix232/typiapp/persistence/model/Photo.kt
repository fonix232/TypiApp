...
@Entity(
    tableName = Constants.TableNames.PHOTO,
    primaryKeys = [Constants.ColumnNames.ID]
)
internal data class Photo(
    @ColumnInfo(name = Constants.ColumnNames.ID) val id: Int,
    @ColumnInfo(name = Constants.ColumnNames.ALBUM_ID) val albumId: Int,
    @ColumnInfo(name = Constants.ColumnNames.TITLE) val title: String,
    @ColumnInfo(name = Constants.ColumnNames.THUMBNAIL_URL) val thumbnailUrl: String,
    @ColumnInfo(name = Constants.ColumnNames.PHOTO_URL) val photoUrl: String
)
