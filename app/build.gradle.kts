...
import extensions.addDatabinding
...
plugins {
    ...
    id(GradleItems.Plugins.AndroidX.SafeArgs_Kotlin)
}
...
dependencies {
    ...
    // Navigation
    implementation(Dependencies.AndroidX.Navigation.Fragment_Ktx)
    implementation(Dependencies.AndroidX.Navigation.UI_Ktx)

    // Dependency Injection
    implementation(Dependencies.Koin.Android)
    implementation(Dependencies.Koin.Android_Ext)
    implementation(Dependencies.Koin.AndroidX_Ext)
    implementation(Dependencies.Koin.AndroidX_Fragment)
