object Dependencies {
    ...
    object AndroidX {
        ...
        object Navigation {
            ...
            val Fragment = "$GROUP:navigation-fragment:$VERSION"
            val Fragment_Ktx = "$GROUP:navigation-fragment-ktx:$VERSION"

            val UI = "$GROUP:navigation-ui:$VERSION"
            val UI_Ktx = "$GROUP:navigation-ui-ktx:$VERSION"
        }
    ...
    object Koin {
        ...
        val Core_Ext = "org.koin:koin-core-ext:${Versions.Koin}"

        val Android = "org.koin:koin-android:${Versions.Koin}"
        val Android_Ext = "org.koin:koin-android-ext:${Versions.Koin}"
        val Scope = "org.koin:koin-android-scope:${Versions.Koin}"
        val ViewModel = "org.koin:koin-android-viewmodel:${Versions.Koin}"


        val AndroidX_Ext = "org.koin:koin-androidx-ext:${Versions.Koin}"
        val AndroidX_Fragment = "org.koin:koin-androidx-fragment:${Versions.Koin}"
